...
Early. The listing store and its snapshot history are built and tested. The source adapters, the
command line, saved searches, address matching, enrichment, criteria, the browser interface,
